...
const STOCK_INSTRUMENTS: InstrumentInfo[] = [
  stock('RELIANCE',   'Reliance Industries',    250,  50),
  stock('TCS',        'Tata Consultancy',        150,  50),
  stock('INFY',       'Infosys',                 300,  25),
  stock('HDFCBANK',   'HDFC Bank',               550,  10),
  stock('ICICIBANK',  'ICICI Bank',              700,  10),
  stock('SBIN',       'State Bank of India',    1500,   5),
  stock('WIPRO',      'Wipro',                  1500,   5),
  stock('AXISBANK',   'Axis Bank',               625,  10),
  stock('KOTAKBANK',  'Kotak Mahindra Bank',     400,  10),
  stock('LT',         'Larsen & Toubro',         150,  25),
  stock('BHARTIARTL', 'Bharti Airtel',           950,   5),
  stock('ITC',        'ITC Limited',            3200,   2),
  stock('BAJFINANCE', 'Bajaj Finance',           125,  50),
  stock('ASIANPAINT', 'Asian Paints',            200,  25),
  stock('MARUTI',     'Maruti Suzuki',           100, 100),
  stock('TATASTEEL',  'Tata Steel',             5500,   2),
  stock('ONGC',       'ONGC',                   4850,   2),
  stock('POWERGRID',  'Power Grid',             4700,   2),
  stock('NTPC',       'NTPC',                   3750,   2),
  stock('ADANIENT',   'Adani Enterprises',       250,  25),
  stock('HINDUNILVR', 'Hindustan Unilever',      300,  25),
  stock('SUNPHARMA',  'Sun Pharmaceutical',      700,  10),
  stock('DRREDDY',    "Dr. Reddy's Lab",         125,  50),
  stock('TECHM',      'Tech Mahindra',           600,  10),
  stock('HCLTECH',    'HCL Technologies',        700,  10),
  stock('ULTRACEMCO', 'UltraTech Cement',         50, 200),
  stock('TITAN',      'Titan Company',           375,  25),
  stock('BAJAJFINSV', 'Bajaj Finserv',          1000,   5),
  stock('NESTLEIND',  'Nestle India',            100, 100),
  stock('DIVISLAB',   "Divi's Laboratories",     200,  50),
]
